...
#define RACKET_IMAGE "racket.png"

CRacket::CRacket(HINSTANCE hInstance, LPCSTR name, int mode, int isFullScreen, int frameRate) :
...
void CRacket::loadResource(LPDIRECT3DDEVICE9 d3ddev)
{
...
void CRacket::renderFrame(LPDIRECT3DDEVICE9 d3ddev, int delta)
{
